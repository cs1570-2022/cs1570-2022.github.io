        ...
        <main>
            <section class="container-fluid d-flex flex-wrap flex-column my-5 px-0 px-sm-5">
                ...
                >
                    ...
                    <ul>
                        <li>TA hours are generally held on in person in the CIT. Location can be found on the course calendar below. There are also Zoom hours for remote students every week.</li>
                        ...
                        <li>When you sign up for TA hours on SignMeUp, please mention the question number in your ticket so we can coordinate helping multiple students with the same question at the same time.</li>
                    </ul>
